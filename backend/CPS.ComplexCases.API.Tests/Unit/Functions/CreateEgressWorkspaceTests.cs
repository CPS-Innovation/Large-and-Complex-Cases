...
namespace CPS.ComplexCases.API.Tests.Unit.Functions
{
    public class CreateEgressWorkspaceTests
    {
        ...
        [Fact]
        public async Task Run_ReturnsOkObjectResult_WithWorkspace_WhenRequestIsValid()
        {
            // Arrange
            ...
            _egressArgFactoryMock
                .Setup(f => f.CreateEgressWorkspaceArg(_name, _description, _templateId))
            ...
            _egressArgFactoryMock.Verify(f => f.CreateEgressWorkspaceArg(_name, _description, _templateId), Times.Once);
