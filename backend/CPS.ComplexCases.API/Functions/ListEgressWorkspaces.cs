  ...
  IInitializationHandler initializationHandler)
{
  ...
  public async Task<IActionResult> Run([HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "v1/egress/workspaces")] HttpRequest req, FunctionContext functionContext)
  {
    ...
    var response = await _egressClient.ListWorkspacesAsync(egressArg, context.Username);
